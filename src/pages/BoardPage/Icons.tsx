...
export const RestartArrowIcon = (color?: Color) => {

    return (
        <svg fill={selectedColor(color).secondary} width="0.55em" height="0.55em" viewBox="-7.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <title>restart</title>
